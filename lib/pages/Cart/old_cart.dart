...
void showCartBottomSheet(context) {
  showModalBottomSheet(
      ...
      builder: (context) {
        return MyOldCartWidget();
      });
}

class MyOldCartWidget extends StatefulWidget {
  const MyOldCartWidget({
    Key? key,
  ...
  @override
  State<MyOldCartWidget> createState() => _MyOldCartWidgetState();
}

class _MyOldCartWidgetState extends State<MyOldCartWidget> {
  @override
